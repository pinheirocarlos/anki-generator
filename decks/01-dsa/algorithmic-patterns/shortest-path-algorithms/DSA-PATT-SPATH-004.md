...
### Dual Coding Visual
<img src="assets/DSA-PATT-SPATH-004.gif" alt="Algoritmo de Bellman-Ford" style="max-width: 100%; height: auto; border-radius: 8px; margin: 12px 0;" />
<p>Visualização: Relaxamento sistemático de todas as arestas V-1 vezes no algoritmo de Bellman-Ford O(V*E).</p>
