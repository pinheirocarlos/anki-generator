...
### Dual Coding Visual
<img src="assets/DSA-STRUCT-TREE-001.gif" alt="Rotação em Árvore AVL" style="max-width: 100%; height: auto; border-radius: 8px; margin: 12px 0;" />
<p>Visualização: Rotação simples à direita em árvore AVL restaurando o fator de balanceamento em tempo O(1).</p>
