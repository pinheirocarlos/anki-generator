...
### Dual Coding Visual
<img src="assets/DSA-STRUCT-STACK-000.gif" alt="Operação Push na Pilha (LIFO)" style="max-width: 100%; height: auto; border-radius: 8px; margin: 12px 0;" />
<p>Visualização: Operação Push inserindo elementos no topo da pilha respeitando a disciplina LIFO.</p>
