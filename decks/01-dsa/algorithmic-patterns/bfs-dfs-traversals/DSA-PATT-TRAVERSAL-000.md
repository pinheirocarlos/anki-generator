...
### Dual Coding Visual
<img src="assets/DSA-PATT-TRAVERSAL-000.gif" alt="Expansão radial em largura (BFS)" style="max-width: 100%; height: auto; border-radius: 8px; margin: 12px 0;" />
<p>Visualização: Expansão radial em largura (BFS) visitando todos os vizinhos por camadas concêntricas de distância.</p>
