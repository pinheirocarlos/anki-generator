...
### Dual Coding Visual
<img src="assets/DSA-PATT-TRAVERSAL-002.gif" alt="Exploração em profundidade (DFS)" style="max-width: 100%; height: auto; border-radius: 8px; margin: 12px 0;" />
<p>Visualização: Exploração em profundidade (DFS) descendo por um ramo até a folha antes do retrocesso (backtracking).</p>
