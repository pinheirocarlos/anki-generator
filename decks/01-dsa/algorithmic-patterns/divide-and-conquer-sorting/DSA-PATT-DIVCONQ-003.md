...
### Dual Coding Visual
<img src="assets/DSA-PATT-DIVCONQ-003.gif" alt="Particionamento In-Place do QuickSort" style="max-width: 100%; height: auto; border-radius: 8px; margin: 12px 0;" />
<p>Visualização: Escolha do pivô e particionamento in-place organizando elementos menores à esquerda e maiores à direita.</p>
