...
### Dual Coding Visual
<img src="assets/DSA-STRUCT-HEAP-001.gif" alt="Operação Sift-Down (Sink) no Heap" style="max-width: 100%; height: auto; border-radius: 8px; margin: 12px 0;" />
<p>Visualização: Operação Sift-Down (Sink) rebaixando a raiz substituta trocando com o maior/menor filho em O(log N).</p>
