...
### Dual Coding Visual
<img src="assets/DSA-PATT-BACKTRACK-000.gif" alt="Recursão e Backtracking" style="max-width: 100%; height: auto; border-radius: 8px; margin: 12px 0;" />
<p>Visualização: Recursão sistemática e desfazimento de decisões na árvore de estados de busca exaustiva.</p>
