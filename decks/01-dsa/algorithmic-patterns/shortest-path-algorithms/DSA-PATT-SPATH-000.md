...
### Dual Coding Visual
<img src="assets/DSA-PATT-SPATH-000.gif" alt="Algoritmo de Dijkstra" style="max-width: 100%; height: auto; border-radius: 8px; margin: 12px 0;" />
<p>Visualização: Relaxamento guloso de arestas com Min-Heap no algoritmo de Dijkstra O((V+E) log V).</p>
