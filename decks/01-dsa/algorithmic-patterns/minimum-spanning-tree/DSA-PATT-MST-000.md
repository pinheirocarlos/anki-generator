...
### Dual Coding Visual
<img src="assets/DSA-PATT-MST-000.gif" alt="Algoritmo de Kruskal" style="max-width: 100%; height: auto; border-radius: 8px; margin: 12px 0;" />
<p>Visualização: Algoritmo de Kruskal unindo componentes conexas via DSU em ordem crescente de peso das arestas.</p>
