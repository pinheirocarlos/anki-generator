...
### Dual Coding Visual
<img src="assets/DSA-PATT-BSEARCH-000.gif" alt="Busca Binária Animação" style="max-width: 100%; height: auto; border-radius: 8px; margin: 12px 0;" />
<p>Visualização: Descarte logarítmico de metade do espaço de busca comparando com o elemento do meio.</p>
